...
$( document ).ready(function() {
  ...
  {
    notHere = true;
    window.location.replace("http://kubernetes.kansea.com/docs/admin/resourcequota/");
  }
  if (forwardingURL.indexOf("horizontal-pod-autoscaler") > -1)
  {
    notHere = true;
    window.location.replace("http://kubernetes.kansea.com/docs/user-guide/horizontal-pod-autoscaling/");
  }
  ...
  {
    notHere = true;
    window.location.replace("http://kubernetes.kansea.com/docs/api/");
  }
  if (forwardingURL.indexOf("docs/user-guide/overview") > -1)
  {
    notHere = true;
    window.location.replace("http://kubernetes.kansea.com/docs/whatisk8s/");
  }
